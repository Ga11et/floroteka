<template>
  <main class="container">
    ...
    <AdaptiveContainer>
      <FilterPart heading="Было / стало" :isLoaded="isPostsLoaded" :refreshFunc="refreshPosts" >
...
export default Vue.extend({
  ...
  components: { PostsInOne, SuspenseConteiner, SidePathContainer, AdaptiveContainer, FilterPart, NotFoundthing },
  computed: {
    posts () {
